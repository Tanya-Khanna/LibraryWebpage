...
if selected_topic == "Generative AI":
    ...
    workshops = {
        "LLMs Spring 2024": {
            ...
            "image": "images/llm_spring2024.png",
        ...
        "Demystifying GenAI": {
            ...
            "image": "images/genai_spring2025.png",
        ...
        "LLMs Theory": {
            ...
            "image": "images/llm_theory_spring2025.png",
        ...
        "AI Agents": {
            ...
            "image": "images/ai_agents_spring2025.jpg",
...
if selected_topic == "Advanced Data Science":
    ...
    workshops = {
        ...
        "NLP Spring 2024": {
            ...
            "image": "images/ChatGPT Image Apr 22, 2025, 12_32_48 PM.png",
        ...
        "Ethical AI": {
            ...
            "image": "images/e99ce085-b7c4-4a4b-9c8f-50bea243efed.png",
        ...
        "Deploying ML": {
            ...
            "image": "images/33d4a7e1-4043-4eaa-9415-70b265158981.png",
        ...
        "RecSys": {
            ...
            "image": "images/0_0GclG1YS4i6O2mKV.png",
...
if selected_topic == "Data Analysis":
    ...
    workshops = {
        "MDA_S24": {
            ...
            "image": "images/82f29cbd-b150-4a62-a7ac-064327f8cb79.png",
        ...
        "Visualization": {
            ...
            "image": "images/workshop3_resized (1).png",
        ...
        "Tableau": {
            ...
            "image": "images/create-complex-elegant-and-robust-dashboards-and-solutions.png",
...
if selected_topic == "Python":
    ...
    workshops = {
        ...
        "AdvancedPython": {
            ...
            "image": "images/1632087530299.png",
        ...
        "SQLPython": {
            ...
            "image": "images/Screenshot 2025-04-24 at 7.29.03 PM.png",
...
if selected_topic == "Data Science":
    ...
    workshops = {
        ...
        "MLS_S24": {
            ...
            "image": "images/regression-vs.png",
        ...
        "MLUS_S24": {
            ...
            "image": "images/1786ca0eI0HsoLG_j9AqVfA.gif",
        ...
        "HypothesisTesting": {
            ...
            "image": "images/1_VhPfZIYkcnV-vWZYaAvgjg.jpg",
